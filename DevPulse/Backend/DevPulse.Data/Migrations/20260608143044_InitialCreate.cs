        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityLogs_Repositories_RepositoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AveragePRMergeTimeHours = table.Column<double>(type: "REAL", nullable: true),
                    RecordedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_RepositoryId_OccurredAt",
                table: "ActivityLogs",
                columns: new[] { "RepositoryId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Metrics_RepositoryId_PeriodStart_PeriodEnd",
                table: "Metrics",
                columns: new[] { "RepositoryId", "PeriodStart", "PeriodEnd" });
